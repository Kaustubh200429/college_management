                            ...
                            <table class="table display data-table text-nowrap">
                                <thead>
                                    <tr style="background-color:#fd7e14; color:white;">
                                        ...
                                        <th style="border: 1px solid black;">Staff Id</th>
                                        <th style="border: 1px solid black;">Name</th>
                                        <th style="border: 1px solid black;">Chat Date</th>
                                ...
                                <tbody>
                                    ...
                                    // Assuming your connect.php file establishes $con connection properly
                                    
                                    // Query to fetch data from teacher_chat where chat_with='student'
