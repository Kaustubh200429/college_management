   ...
   <body>
      ...
      <main>
         ...
         <section class="page-banner bg-image section-padding" style="background-image: url('images/banner_new1.PNg');; background-size: cover; background-position: center;">
            ...
            <div class="container">
               <h2 class="wow fadeInUp" data-wow-duration="1.3s" data-wow-delay=".3s">Our College Fresher's Day</h2>
               ...
               <div class="row g-4">
                  <div class="col-lg-4 col-md-6">
                     <div class="item">
                        ...
                        <img src="images/freshersday2022.jpg" class="shadow" alt="image">
                        </a>
                        <div class="content">
                           <h3><a href="team-single.html">Fresher's Day</a></h3>
                           <span>2022</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
                     <div class="item">
                        <a href="team-single.html" class="image d-block">
                        <img src="images/freshersday2023.jpg" class="shadow" alt="image">
                        </a>
                        <div class="content">
                           <h3><a href="team-single.html">Fresher's Day</a></h3>
                           <span>2023</span>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="item">
                        <a href="team-single.html" class="image d-block">
                        <img src="images/freshersday20221.jpg" class="shadow" alt="image">
                        </a>
                        <div class="content">
                           <h3><a href="team-single.html">Fresher's Day</a></h3>
                           <span>2024</span>
